...
inline WebSocketClient::WebSocketClient(net::io_context& ioc, ssl::context& ctx)
...
inline void WebSocketClient::run(std::string host, std::string port, std::string text) {
...
inline void WebSocketClient::close() {
...
inline void WebSocketClient::on_resolve(beast::error_code ec, tcp::resolver::results_type results) {
  if (ec)
  ...
  beast::get_lowest_layer(ws_).async_connect(results,
                                             beast::bind_front_handler(&WebSocketClient::on_connect,
                                                                       shared_from_this()));
}

inline void WebSocketClient::on_connect(beast::error_code ec,
...
inline void WebSocketClient::on_ssl_handshake(beast::error_code ec) {
  if (ec)
...
inline void WebSocketClient::on_handshake(beast::error_code ec) {
  if (ec)
...
inline void WebSocketClient::on_write(beast::error_code ec, std::size_t bytes_transferred) {
...
inline void WebSocketClient::on_read(beast::error_code ec, std::size_t bytes_transferred) {
  boost::ignore_unused(bytes_transferred);
...
inline void WebSocketClient::on_close(beast::error_code ec) {
  if (ec)
...
inline void WebSocketClient::setReadCallback(ReadCallback callback) {
  this->onReadCallback = callback;
}

inline void WebSocketClient::setHeaders(const std::map<std::string, std::string>& headers) {
