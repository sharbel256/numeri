...
public:
  ...
  OrderBuilder&
  limitLimitGtc(const std::string& baseSize, const std::string& limitPrice, bool postOnly = false) {
...
inline std::string
getIsoTimestamp(std::chrono::system_clock::time_point time = std::chrono::system_clock::now()) {
